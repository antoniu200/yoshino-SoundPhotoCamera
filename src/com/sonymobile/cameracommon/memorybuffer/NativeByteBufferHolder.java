...
public class NativeByteBufferHolder {
    ...
    private static String dump() {
        return "count:" + sDebugCount + " total[kb]:" + (sDebugUsedBytes / PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID) + " used[kb:" + (Debug.getNativeHeapAllocatedSize() / PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID) + " free[kb]:" + (Debug.getNativeHeapFreeSize() / PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID);
    }
