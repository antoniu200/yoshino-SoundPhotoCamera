...
public class CameraDeviceHandler implements ParameterApplyer, Camera.ErrorCallback {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void releaseCameraImmediatelyNotSynchronized() throws InterruptedException {
    ...
    public void startLiveViewFinder(SurfaceHolder surface) throws IOException {
        Camera camera = getCameraInstance();
        if (camera != null) {
            if (surface == null) {
    ...
    class OnPictureTakenCallback implements Camera.PictureCallback {
        ...
        public void onPictureTaken(byte[] data, Camera camera) throws IOException {
    ...
    class OnFaceDetectionCallback implements Camera.FaceDetectionListener {
        ...
        public void onFaceDetection(Camera.Face[] faces, Camera camera) {
            ...
            ResearchUtil.getInstance().setFaceNum(faces.length);
