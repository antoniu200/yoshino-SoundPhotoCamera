...
public enum SelfTimer implements ParameterValue, SelfTimerInterface {
    LONG(R.drawable.cam_selftimer_setting_10sec_icn, R.string.cam_strings_self_timer_10_txt, SearchAuth.StatusCodes.AUTH_DISABLED, OnScreenButtonGroup.ButtonType.SELFTIMER_LONG),
