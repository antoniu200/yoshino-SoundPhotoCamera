...
public interface IFastViewService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IFastViewService {
        ...
        public static IFastViewService asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin != null && (iin instanceof IFastViewService)) {
                return (IFastViewService) iin;
            }
