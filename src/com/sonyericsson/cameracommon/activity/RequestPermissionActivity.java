...
public class RequestPermissionActivity extends Activity {
    ...
    enum PermissionGroup {
        ...
        STORAGE("android.permission-group.STORAGE", storagePermsForSdk(), RequestPermissionActivity.INVALID_ID, R.string.cam_strings_runtime_permission_rationale_storage_txt),
        ...
        private static List<String> storagePermsForSdk() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public String getPermissionGroupLabel(PermissionGroup group) {
