...
public class CameraExtensionValues {
    ...
    public static final String EX_FOCUS_MODE_MANUAL = "manual";
    ...
    public static final String EX_POWER_SAVE_LOW = "low-power";
    public static final String EX_POWER_SAVE_ULTRA_LOW = "ultra-low-power";
    ...
    public static final String KEY_EX_CLIMAX_RECOGNITION = "sony-climax-recognition";
    public static final String KEY_EX_CLIMAX_RECOGNITION_VALUES = "sony-climax-recognition-values";
    public static final String KEY_EX_CLIMAX_RECOGNITION_VALUES_AUTO = "auto";
    public static final String KEY_EX_CLIMAX_RECOGNITION_VALUES_OFF = "off";
    public static final String KEY_EX_CLIMAX_RECOGNITION_VALUES_ON = "on";
    ...
    public static final String KEY_EX_MANUAL_FOCUS_FOR_1M = "sony-manual-focus-for-1m";
    public static final String KEY_EX_MANUAL_FOCUS_FOR_INFINITY = "sony-manual-focus-for-infinity";
    ...
    public static final String KEY_EX_MAX_MANUAL_FOCUS = "sony-max-manual-focus";
    ...
    public static final String KEY_EX_MAX_SUPER_SLOW_FRAME_RATE = "sony-max-super-slow-frame-rate";
    ...
    public static final String KEY_EX_MIN_MANUAL_FOCUS = "sony-min-manual-focus";
    ...
    public static final String KEY_EX_OBJECT_TRACKING_RECT_SUPPORTED = "sony-object-tracking-rect-supported";
    ...
    public static final String KEY_EX_PLAY_SHUTTER_SOUND = "key-sony-ext-playshuttersound";
    ...
    public static final String KEY_EX_SUPER_SLOW_FRAME_RATE = "sony-super-slow-frame-rate";
    ...
    public static final String TAG = "CameraExtensionValues";
    ...
    static {
        ...
        sSceneMap.put(ShootingLabel.RECOGNIZED_SCENE_ACTION, 1);
        sSceneMap.put(ShootingLabel.RECOGNIZED_SCENE_PORTRAIT, 2);
        sSceneMap.put("landscape", 3);
        sSceneMap.put(ShootingLabel.RECOGNIZED_SCENE_NIGHT, 4);
        sSceneMap.put(ShootingLabel.RECOGNIZED_SCENE_NIGHT_PORTRAIT, 5);
        sSceneMap.put(ShootingLabel.RECOGNIZED_SCENE_THEATRE, 6);
        sSceneMap.put(ShootingLabel.RECOGNIZED_SCENE_BEACH, 7);
        sSceneMap.put(ShootingLabel.RECOGNIZED_SCENE_SNOW, 8);
        sSceneMap.put(ShootingLabel.RECOGNIZED_SCENE_SUNSET, 9);
        sSceneMap.put(ShootingLabel.RECOGNIZED_SCENE_STEADYPHOTO, 10);
        sSceneMap.put(ShootingLabel.RECOGNIZED_SCENE_FIREWORKS, 11);
        sSceneMap.put(ShootingLabel.RECOGNIZED_SCENE_SPORTS, 12);
        sSceneMap.put(ShootingLabel.RECOGNIZED_SCENE_PARTY, 13);
        sSceneMap.put(ShootingLabel.RECOGNIZED_SCENE_CANDLELIGHT, 13);
        sSceneMap.put("document", 16);
        sSceneMap.put("backlight", 17);
        sSceneMap.put("backlight-portrait", 18);
        VALID_VARIABLE_PARAMETER_KEY_ARRAY = new String[]{"preview-size", "preview-frame-rate", "preview-fps-range", "picture-size", "jpeg-quality", "rotation", "gps-latitude", "gps-longitude", "gps-altitude", "gps-timestamp", "gps-processing-method", "whitebalance", "scene-mode", "flash-mode", "focus-mode", "focus-areas", "video-size", "recording-hint", "exposure-compensation", CommonSettingConstants.VolumeKeyValue.ZOOM, "metering-areas", KEY_EX_METERING_MODE, KEY_EX_IMAGE_STABILIZER, KEY_EX_VIDEO_STABILIZER, KEY_EX_SMILE_DETECTION, KEY_EX_FOCUS_AREA, KEY_EX_AE_MODE, KEY_EX_ISO, KEY_EX_VIDEO_NR, KEY_EX_SOFT_SKIN_LEVEL_PICTURE, KEY_EX_SOFT_SKIN_LEVEL_PREVIEW, EX_DC_MODE_FOR_PREVIEW, EX_DC_MODE_FOR_VIDEO, EX_DC_MODE_FOR_PICTURE, KEY_EX_AWB_COMPENSATION_AB, KEY_EX_SHUTTER_SOUND, KEY_EX_REC_SOUND, KEY_EX_POWER_SAVE_MODE, KEY_EX_MANUAL_FOCUS, KEY_EX_SHUTTER_SPEED, KEY_EX_CLIMAX_RECOGNITION, KEY_EX_SUPER_SLOW_FRAME_RATE, KEY_EX_SUPER_SLOW, KEY_EX_SHUTTER_SPEED_LIMIT};
    ...
    public static int convertSceneStringToInt(String str) {
        Integer ret;
        if (str == null || (ret = sSceneMap.get(str)) == null) {
            return -1;
        }
        return ret.intValue();
    }
