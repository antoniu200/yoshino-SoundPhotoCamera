...
public class CameraCommonProviderConstants {
    ...
    public static final String CAMERAPARAMETER_TABLE = "cameraparameters";
    ...
    public static final Uri CAMERAPARAMETER_CONTENT_URI = Uri.withAppendedPath(BASE_URI, "cameraparameters");
    public static final Uri COMMONSETTING_CONTENT_URI = Uri.withAppendedPath(BASE_URI, "commonsettings");

    public interface CameraParameterColumns extends BaseColumns {
