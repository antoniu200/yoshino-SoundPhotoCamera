...
public class RecordingUtil {
    ...
    public static long getMaxDurationMillisecond(long averageSizeKBytePerMin, StorageController controller) {
        long recordableStorageSizeByte = getRecordableSizeKBytes(controller) * PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID;
        ...
        long sizeBytePerSec = (PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID * averageSizeKBytePerMin) / 60;
    ...
    public static long getMaxRecordingDuration(CamcorderProfile profile, StorageController controller) {
        long videoBitRateKBytesPerMin = ((profile.videoBitRate * 60) / PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID) / 8;
        long audioBitRateKBytesPerMin = ((profile.audioBitRate * 60) / PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID) / 8;
