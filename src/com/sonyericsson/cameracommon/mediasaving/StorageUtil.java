...
public class StorageUtil {
    ...
    public static CameraStorageType getStorageTypeFromPath(String path, Context context) throws NoSuchMethodException, SecurityException {
    ...
    public static CameraStorageType getStorageTypeFromUri(Uri uri, Context context) throws NoSuchMethodException, SecurityException, IOException {
    ...
    private static String getVolumePath(VolumeInfo volume) throws NoSuchMethodException, SecurityException {
        File file = null;
        try {
    ...
    public static boolean isPreinstalledOrUpdatedPreinstalledApp(Context context) throws PackageManager.NameNotFoundException {
        boolean z = false;
        try {
    ...
    public static boolean isSdCardGranted(Context context, Uri checkUri) throws FileNotFoundException {
        ...
        try {
            ...
            if (fileUri != null) {
                if (DocumentsContract.deleteDocument(context.getContentResolver(), fileUri)) {
                    ...
                    CameraLogger.e(TAG, "SD Card is no granted for delete error.");
                }
            }
