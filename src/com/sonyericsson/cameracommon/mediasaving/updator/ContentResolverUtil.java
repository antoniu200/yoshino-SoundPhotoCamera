...
public class ContentResolverUtil {
    ...
    public static boolean deleteImageImpl(Context context, Uri uri, boolean withMpo) throws FileNotFoundException {
        if (uri == null) {
            return false;
        }
    ...
    private static boolean deleteImageByFilePath(Context context, String filePath) throws FileNotFoundException {
