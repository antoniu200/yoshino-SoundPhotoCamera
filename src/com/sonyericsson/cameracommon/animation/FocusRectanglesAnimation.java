...
public class FocusRectanglesAnimation {
    ...
    private final AnimationConfig mTouchConfig = new AnimationConfig(R.dimen.focus_rect_single_width, R.dimen.focus_rect_single_height, R.attr.focus_indicator_animation_mag_touch, R.integer.focus_indicator_animation_focusin_duration);
