...
public class MessagePopup implements BaseActivity.LayoutOrientationChangedListener {
    ...
    public void showDeviceErrorMessage() {
        ...
        if (builder != null) {
            ...
            showDeviceError(builder);
            sendGoogleAnalyticsCameraNotAvailableEvent();
        }
    }
    ...
    private String getSoftwareLicensesFromAssets(Context context, String fileName) throws Throwable {
        BufferedReader bufReader = null;
        StringBuilder builder = new StringBuilder();
        try {
            try {
                BufferedReader bufReader2 = new BufferedReader(new InputStreamReader(context.getResources().getAssets().open(fileName)));
                try {
                    ...
                    CameraLogger.e("TraceLog", "Can not load assets file.", e);
                    if (bufReader != null) {
                        try {
                            bufReader.close();
                        } catch (IOException e3) {
                            CameraLogger.e("TraceLog", "Fail to close BufferedReader.", e3);
                        }
                    }
                    ...
                    if (bufReader != null) {
                        try {
                            ...
                            CameraLogger.e("TraceLog", "Fail to close BufferedReader.", e4);
                        }
                    }
                    throw th;
                }
