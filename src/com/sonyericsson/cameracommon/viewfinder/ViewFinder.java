...
public abstract class ViewFinder implements ViewFinderInterface, LocationAcquiredListener, BaseActivity.LayoutOrientationChangedListener, StorageController.StorageListener, OnClickCapturingModeButtonListener, StorageController.StorageDialogStateListener, StorageController.SdCorruptListener {
    ...
    protected void setOrientation(int orientation) throws Resources.NotFoundException {
        ...
        if (this.mBaseLayout.isHeadUpDisplayReady()) {
        }
    }
    ...
    public boolean isSetupNeeded() {
        return this.mIsRequestedLaterSetup;
    }
